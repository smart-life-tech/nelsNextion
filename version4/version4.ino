...
unsigned long lastPrintTime = 0; // Variable to store the last time values were printed
...
void manageMotorBehavior()
{
    ...
    if (currentTime - lastPrintTime >= 1000)
    {
        ...
        // Send motor state to Nextion display
        sendMotorStateToNextion(motorState);
    }
...
void checkTotalRunTime()
{
    if (totalRunTime > 0 && !totalRunTimePaused)
    {
        ...
        else if (currentTime - timenow >= 1000)
        {
            ...
            sendNextionCommand("t21.txt=\"" + String(countDown) + "\"");
        }
    }
}
...
{
    // Create a command to update text object t20 on the Nextion display
    String command = "t20.txt=\"";
    switch (state)
    {
    case 0:
        command += "Idle";
    ...
    case 2:
        ...
        break;
    case 3:
        command += "Ramping down";
        break;
    case 4:
        command += "Pausing";
        break;
    case 5:
        command += "Reversing direction";
        break;
    case 6:
        command += "Paused";
        break;
